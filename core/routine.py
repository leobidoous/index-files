        ...
        for padrao in [primeiro_padrao, segundo_padrao]:
            try:
                arquivo_indexado_dict = {
                    ...
                    'data_entrada': datetime.strptime(text[padrao.get('data_entrada')], '%d/%m/%Y %H:%M:%S') if text[padrao.get('data_entrada')] != '' else '',
                    'data_arquivo': datetime.strptime(text[padrao.get('data_arquivo')], '%d/%m/%Y') if text[padrao.get('data_arquivo')] != '' else '',
